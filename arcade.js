...
var DEMO_DECKS = [
  ...
  { id: "pd1-anus-rectum", name: "Anus & Rectum Examination", color: "accent",
    ...
    cards: [
      ...
      ["What should be inspected before performing the DRE?", "The sacrococcygeal and perianal areas, then the anus itself."],
      ...
      ["What is the first step of the digital rectal exam (DRE)?", "Lubricate a gloved index finger before insertion."],
      ["During the DRE, what should you ask the patient to do after inserting your fingertip?", "Squeeze the anal sphincter, to assess sphincter tone."],
      ["What is assessed by asking the patient to squeeze during the DRE?", "Anal sphincter tightness or laxity."],
      ["What special maneuver evaluates the prostate during this exam?", "A prostatic examination, performed by palpating anteriorly during the DRE."],
    ...
    matchCards: [
      ...
      ["Prostatic exam", "Special DRE maneuver"],
      ["Anal & perianal lesion history", "Key anorectal history item"]
    ]},
  { id: "pd1-male-gu-prostate", name: "Male GU & Prostate Examination", color: "accent2",
    ...
    cards: [
      ...
      ["Where is the prostate palpated from during the DRE?", "The posterior surface of the prostate, via the anterior rectal wall."],
      ...
      ["What lab test is used to screen for prostate cancer?", "Prostate-specific antigen (PSA)."],
    ...
    matchCards: [
      ["Transillumination", "Assesses scrotal contents (e.g., hydrocele)"],
      ["Valsalva maneuver", "Used with inspection/palpation to assess groin hernia"],
      ["PSA", "Prostate cancer screening lab test"],
      ["Prostate palpation approach", "Posterior surface, via rectal wall"],
      ["Testicular self-exam", "Patient self-screening technique"],
      ["Erectile dysfunction", "Concerning GU history symptom"],
      ["Penile discharge/lesions", "Concerning GU history symptom"],
  ...
  { id: "pd1-abdominal-exam", name: "Abdominal Examination", color: "accent3",
    ...
    cards: [
      ...
      ["How is CVA tenderness assessed?", "Strike the costovertebral angle with the ulnar surface of a fist while the palm of the other hand rests against the area, with the patient sitting up."]
    ],
    matchCards: [
      ...
      ["CVA tenderness technique", "Fist percussion over costovertebral angle"],
  ...
  { id: "pd1-lung-thorax-exam", name: "Lung & Thorax Examination", color: "accent4",
    ...
    cards: [
      ...
      ["What is bronchophony, and what does it indicate?", "Increased, louder-than-normal transmission of the spoken voice (e.g., saying \"ninety-nine\"), suggesting consolidation."],
      ...
      ["What is whispered pectoriloquy?", "Whispered words (e.g., \"1-2-3\") heard loudly and clearly through the stethoscope, indicating consolidation."],
  ...
  { id: "pd1-skin-hair-nail-exam", name: "Skin, Hair & Nail Examination", color: "accent",
    ...
    cards: [
      ...
      ["What distinguishes vellus hair from terminal hair?", "Vellus hair is short, fine, and lightly pigmented (\"peach fuzz\"); terminal hair is coarser and pigmented (e.g., scalp hair)."],
      ...
      ["In what order should the skin, hair, and nail exam typically be performed on a full-body exam?", "Inspection followed by palpation, integrated with other exam components as skin becomes exposed (e.g., during lung auscultation)."],
  ...
  { id: "pd1-eye-exam", name: "Eye Examination", color: "accent2",
    ...
    cards: [
      ...
      ["Which cranial nerve innervates the lateral rectus muscle, and what action does it perform?", "CN VI (abducens); it abducts the eye (moves it outward, away from the nose)."],
      ["Which cranial nerve innervates the superior oblique muscle, and what does it do?", "CN IV (trochlear); it rotates the top of the eye toward the nose (intorsion) and depresses the eye."],
    ...
    matchCards: [
      ["Superior rectus (CN III)", "Elevates the eye"],
      ["Inferior rectus (CN III)", "Depresses the eye"],
      ["Medial rectus (CN III)", "Adducts the eye"],
      ["Lateral rectus (CN VI)", "Abducts the eye"],
      ["Superior oblique (CN IV)", "Intorsion & depression"],
      ["Inferior oblique (CN III)", "Extorsion & elevation"],
  ...
  { id: "pd1-general-survey-vitals", name: "General Survey & Vital Signs", color: "accent3",
    ...
    cards: [
      ...
      ["When using a 1-10 pain scale, what should you always ask the patient?", "What their personal \"10\" reference point is (e.g., childbirth, a fracture)."],
      ...
      ["What is the protocol for assessing orthostatic vital signs?", "Measure blood pressure and heart rate supine, then again after standing, checking for a significant drop in BP or rise in HR."],
    ...
    matchCards: [
      ...
      ["BP cuff position", "2.5 cm above antecubital crease"],
  ...
  { id: "pd1-cardio-pv-exam", name: "Cardiovascular & Peripheral Vascular Examination", color: "accent4",
    ...
    cards: [
      ["What generates the first heart sound, S1?", "Closure of the AV valves (mitral and tricuspid) at the start of systole."],
      ...
      ["Where is the mitral valve (S1) best auscultated?", "Left 5th intercostal space at the midclavicular line (the apex/PMI)."],
      ...
      ["What are the normal characteristics of the PMI/apical impulse?", "About 2.5 cm in diameter, small amplitude, felt as a brisk, gentle tap."],
      ["Where is the normal PMI located?", "5th intercostal space, left midclavicular line."],
    ...
    matchCards: [
      ["S1", "AV valve closure (mitral & tricuspid)"],
      ["S2", "Semilunar valve closure (aortic & pulmonic)"],
      ["Aortic auscultation area", "Right 2nd ICS"],
      ["Pulmonic auscultation area", "Left 2nd–3rd ICS"],
      ["Tricuspid auscultation area", "Left 4th ICS, lower sternal border"],
      ["Mitral auscultation area", "Left 5th ICS, midclavicular line"],
      ["Normal pulse pressure", "30–40 mmHg"],
      ["Pulsus parvus", "Weak pulse (atherosclerotic PVD)"],
      ["Pulsus tardus", "Sluggish pulse (aortic stenosis/low CO)"],
  ...
  { id: "pd1-hent-exam", name: "HENT (Head, Ears, Nose, Throat) Examination", color: "accent",
    ...
    cards: [
      ["What is the general physical exam sequence used for the HENT region, and how does it differ from the abdominal exam?", "Inspection, Palpation, Percussion, Auscultation (IPalPerA) — unlike the abdomen, which uses IAPerPal so auscultation isn't altered by palpation/percussion."],
    ...
    matchCards: [
      ["Pars flaccida", "Small, loose superior TM portion"],
      ...
      ["HENT exam sequence", "Inspection → Palpation → Percussion → Auscultation"],
